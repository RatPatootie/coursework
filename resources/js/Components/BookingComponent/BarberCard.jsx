...
const BarberCard = ({id, img_url, name, type, comments, rate, isSelected, onSelect }) => {
    const renderStars = () => {
    ...
    return (
        <div className="p-4 bg-gray-200/40 shadow-md rounded-lg flex w-full flex-row justify-between items-center space-x-4">
            <div className='flex flex-row justify-center items-center space-y-2'>
                ...
                <img src={img_url} alt={`${name}'s picture`} className="w-20 h-20 object-cover rounded-lg ml-4" />
                <div className='p-4'>
            ...
            <div className="p-4 flex flex-row justify-center items-center space-x-4">
                <div>
                    <Link href={route('barber.info', { id: id })} className="ml-2 p-1">
